...
row1.addEventListener("input", function () {
...
column1.addEventListener("input", function () {
...
row2.addEventListener("input", function () {
...
column2.addEventListener("input", function () {
...
(void 0).addEventListener("input", numberLengthListFunction);